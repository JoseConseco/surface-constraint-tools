...
def draw_surface_constraint_ui(layout):
    ...
    if not props.settings_ui_is_visible:
        ...
        row.prop_search(props, 'target', props, "available_targets", text = "", icon = 'OBJECT_DATA' )
        oper = row.operator("object.objectpicker_surf_constraint", text="", icon="EYEDROPPER")
        oper.targetPropName = 'target'
